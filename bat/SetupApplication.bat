...
:: Android packaging
set AND_CERT_NAME="Tutorial01"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Tutorial01.p12
...
set IOS_PROVISION=cert\Tutorial01.mobileprovision
...
set APP_ID=air.Tutorial01

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Tutorial01
